...
El modelo fue entrenado y para cada día se obtuvieron los valores de los coeficientes para el modelo, de forma similar a la presentada en @eq-compleja
...
donde $\beta_2, \beta_3, \beta_4, \beta_5, \beta_6$ son coeficientes que se determinan en todo el año. Mientras que $\beta$ y $\alpha$ se determinan de forma diaria. Por simplicidad, los coefficientes se ponen dentro de una tabla, la cual es añadida a través de los a **Assets**. La cual tiene la siguiente forma.
...
|--------|--------|--------|--------|--------|--------|--------|--------|
| 3.9526 | 0.4266 | 0.2033| -0.3986 | -0.1151 | -0.2979| 0.0128 | 2004-01-01 | 1072915200 |
|1.1116 | 0.2307 | 0.2033 | -0.3986 | -0.1151 | -0.2979 | 0.01281 | 2004-01-02 | 1073001600 |


Esta tabla se sube usando la pestaña **Assets**, se resalta en particular la columna 'system:index', esta es la fecha en ['Unix time'](https://en.wikipedia.org/wiki/Unix_time), es importante, pues dentro de GEE nos sirve para poder usar el filtro de fechas (`.filterDate`). Para poder hacer uso de los 
