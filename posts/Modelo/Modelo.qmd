...
```
Estas las podemos combinar para que funcionen como pipeline es decir podemos filtrar primero por fecha y después por los que intersectan al punto dentro de la misma ejecución como se muestra a continuación
...
Este tipo de acciones las podemos implementar también 
